...
export default function AuthModal({
  ...
  const handleLogin = async (loginEmail, loginPass) => {
    ...
    if (res.success) {
      ...
      if (notice)
        notice(
          `Authenticated as ${res.user.full_name} (${res.user.role})`,
          "success",
        );
      onClose();
    } else {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "20px" }}>
          ...
          >
            <button
              ...
              disabled={loading}
              onClick={() =>
                handleLogin("admin@aeromesh.internal", "Admin123!")
              }
              style={{
            ...
            <button
              ...
              disabled={loading}
              onClick={() =>
                handleLogin("analyst@aeromesh.internal", "Analyst123!")
              }
              style={{
            ...
            <button
              ...
              disabled={loading}
              onClick={() =>
                handleLogin("operator@aeromesh.internal", "Operator123!")
              }
              style={{
        ...
        <div
          style={{
            borderTop: "1px solid var(--border-color, #2a3548)",
            paddingTop: "16px",
            marginTop: "16px",
          }}
        >
