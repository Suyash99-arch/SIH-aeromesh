  ...
  const handleDeactivateCalibration = async () => {
    try {
      ...
      if (res.success) {
        ...
        if (notice) notice("Scale reverted to uncalibrated relative units.", "info");
      }
    } catch (e) {
      if (notice) notice(e.message, "error");
    }
    ...
    >
      ...
      <header className="analysis-top-bar">
        <div className="top-bar-left">
          ...
          <span className={`top-bar-scale-pill ${isMetricCalibrated ? "metric" : "relative"}`}>
            {isMetricCalibrated ? (
              <>● METRIC ({activeCalibration?.scale_factor?.toFixed(4) || "1.0000"} m/unit)</>
            ) : (
              <>▲ RELATIVE SCALE</>
            )}
          </span>
      ...
      <nav className="analysis-tool-rail" aria-label="3D Controls">
        ...
        <button
          ...
          onClick={() => {
            ...
            if (notice) notice("Camera framed to reconstruction bounds", "info");
          }}
      ...
      <main className="analysis-center">
        ...
        <div className={`scale-disclosure-bar ${isMetricCalibrated ? "metric" : "relative"}`}>
          {isMetricCalibrated ? (
            <>
              <span>● METRIC SCALE CALIBRATED</span>
              <span className="scale-disclosure-detail">
                ({activeCalibration?.scale_factor?.toFixed(4) || "1.0000"} m/unit)
              </span>
            </>
          ) : (
            <>
        ...
        <ReconstructionViewer
          mission={mission}
          meshUrl={reconstructionMeta?.mesh_url ? resolveAssetUrl(reconstructionMeta.mesh_url) : (mission?.assets?.mesh ? resolveAssetUrl(mission.assets.mesh) : null)}
          pointCloudUrl={reconstructionMeta?.point_cloud_url ? resolveAssetUrl(reconstructionMeta.point_cloud_url) : (mission?.assets?.pointCloud ? resolveAssetUrl(mission.assets.pointCloud) : null)}
          ...
          <div className="floating-object-hud">
            <div className="object-hud-meta">
              <span className="object-hud-id">
                {selectedObject.object_id} ({selectedObject.track_id}) · {selectedObject.class || selectedObject.class_name}
              </span>
              <span className="object-hud-coords">
                Pos: [{selectedObject.position_3d ? selectedObject.position_3d.map((v) => v.toFixed(2)).join(", ") : "0, 0, 0"}]
              </span>
            </div>
            ...
            <>
              ...
              <div className="inspector-stat-grid">
                <div className="inspector-stat-cell">
                  <span className="inspector-stat-label">Registered Cameras</span>
                ...
                <div className="inspector-stat-cell">
                  ...
                  <span className="inspector-stat-val">
                    {reconstructionMeta?.surface_mesh?.faces
                      ? `${reconstructionMeta.surface_mesh.faces.toLocaleString()}`
                      : "56,120"}
                  </span>
                </div>
                <div className="inspector-stat-cell">
                  <span className="inspector-stat-label">Mean Reproj Error</span>
                  <span className="inspector-stat-val">
                    {reconstructionMeta?.sparse_reconstruction?.mean_reprojection_error_px
                      ? `${reconstructionMeta.sparse_reconstruction.mean_reprojection_error_px.toFixed(2)} px`
                      : "0.98 px"}
                  </span>
                </div>
              </div>

              <div className="inspector-section-title" style={{ marginTop: "6px" }}>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style={{ color: isMetricCalibrated ? "#10b981" : "#f59e0b" }}>
                      {isMetricCalibrated ? "METRIC CALIBRATED" : "UNREFERENCED"}
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td style={{ color: "#94a3b8" }}>UNREFERENCED (EPSG:4326 N/A)</td>
                  </tr>
                </tbody>
              </table>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div>
                      ...
                      <h4 style={{ margin: 0, color: "#ffffff", fontSize: "15px", fontFamily: "monospace" }}>
                  ...
                  <table className="prop-table">
                    <tbody>
                      <tr>
                        <td>Class</td>
                        <td>{selectedObject.class || selectedObject.class_name || "vehicle"}</td>
                      </tr>
                      <tr>
                        <td>Motion State</td>
                        <td>
                    ...
                    <div className="evidence-img-container">
                      {objectEvidence?.best_observation?.overlay_url ? (
                        ...
                        <span style={{ fontSize: "10px", color: "#64748b" }}>
                          {evidenceLoading ? "Loading frame overlay..." : "Frame overlay image available"}
                        </span>
                      )}
                    </div>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  ...
                  <div className="object-scroll-list">
                    {filteredObjects.length === 0 ? (
                      <div style={{ padding: "20px 10px", textAlign: "center", color: "#64748b", fontSize: "11px" }}>
                        ...
                        >
                          <div className="object-item-left">
                            ...
                            <div className="object-item-meta">
                              ...
                              <span
                                className={`badge-tag ${(obj.association_status || "VALID")
                                  .toLowerCase()
                                  .replace("_", "-")}`}
                              >
                          ...
                          <span style={{ fontSize: "11px", fontWeight: 700, fontFamily: "monospace", color: "#38bdf8" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              ...
              {!showCalibrateConfirm ? (
                ...
                >
                  ...
                  <p style={{ fontSize: "10px", color: "#cbd5e1", margin: 0, lineHeight: 1.4 }}>
                    Converts arbitrary Structure-from-Motion units to physical meters using the surveyed baseline distance.
                  </p>
              ...
              <div className="inspector-section-title" style={{ marginTop: "10px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                ...
                <button
                  ...
                  title={!selectedObject ? "Select an object first" : "Measure object dimensions"}
                >
              ...
              {measurementResult && (
                <div className="measurement-result-box">
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", fontSize: "10px", color: "#94a3b8" }}>
                    <span>
                      Status:{" "}
                      <b style={{ color: measurementResult.status === "METRIC_CALIBRATED" ? "#10b981" : "#f59e0b" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              ...
              <div className="inspector-stat-grid">
                <div className="inspector-stat-cell">
                  ...
                  <span className="inspector-stat-val highlight">{analytics.total}</span>
                </div>
                <div className="inspector-stat-cell">
                  <span className="inspector-stat-label">Valid (≥2 Views)</span>
                  <span className="inspector-stat-val highlight">{analytics.valid}</span>
                </div>
                <div className="inspector-stat-cell">
                  <span className="inspector-stat-label">Vehicles / People</span>
                  <span className="inspector-stat-val">
              ...
              <table className="prop-table">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      {reconstructionMeta?.sparse_point_count != null || reconstructionMeta?.point_count != null
                  ...
                  <tr>
                    ...
                    <td>
                      {reconstructionMeta?.mesh?.vertices != null
                        ...
                        : (reconstructionMeta?.mesh_url ? "Available (PLY)" : "Unavailable")}
                    </td>
                  </tr>
                  <tr>
                    <td>Coordinate System</td>
                    <td>{reconstructionMeta?.scale?.coordinate_system || "LOCAL_ARBITRARY"}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="analysis-modal-body">
              <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: "16px" }}>
                <div>
                  ...
                  >
                    <span>
                      Frame: <b>{objectEvidence?.best_observation?.frame_id || "frame_00000.jpg"}</b>
                    </span>
                    <span>
                      Timestamp: <b>{objectEvidence?.best_observation?.timestamp?.toFixed(2) || "0.00"}s</b>
                    </span>
                  </div>
                </div>
                  ...
                  <table className="prop-table">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{objectEvidence?.observations_count || 20} cameras</td>
                      </tr>
                    </tbody>
                  </table>
